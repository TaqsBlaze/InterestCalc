...
import SplashScreen
import Years,Months
from UI import UI_transition
from UI import WindowProperties
from UI import Extras
from settings import OsConfig
from season import Info
"""
==========================================================================================================
...
"""
def exp():
    fld = open(r'files/dtt.txt','w')
    fld.write(datetime.datetime.strptime)
#//Declaring constant variables

Header_Title = "Blink";
_ProgramSize_ = '950x620+146+75';
_ProgramVersion_= '1.5.10.0 beta';
...
try:
    ...
    patch01.Patch().menuUI(window,info);
except Exception,e:
    print e
...
'''
from files.patchs import patch01
patch01.SetTheme(window,label1,label2,P,R,T,Container,screen,Months,Years);
'''
...
#//Now lets render our screen
    ...
    #patch01.menuUI(window,info,window,Label_color,grid,P,R,T,Container,screen,Months,Years);
    def Screen(self):
...
Main().Screen();
OsConfig.Os(os.name,window)
window.mainloop();

from files.tools import Cleanner
Cleanner.Cleanner()
